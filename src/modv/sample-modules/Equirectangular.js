export default {
  ...
  props: {
    mX: { type: 'float', default: 0.5, label: 'Mouse X' },
    mY: { type: 'float', default: 0.5, label: 'Mouse Y' },
    mZ: { type: 'float', default: 0.5, label: 'Mouse Z' },
    mW: { type: 'float', default: 0.5, label: 'Mouse W' }
  }
}
